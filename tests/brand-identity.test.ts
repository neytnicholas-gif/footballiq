...
describe('Early Shout identity', () => {
  ...
  it('offers the flagship Player Market first and keeps a quick guest game available', () => {
    ...
    expect(home).toContain('BUILD YOUR TEAM')
    expect(home).toContain('Premier League')
    expect(home).toContain('La Liga')
    expect(home).toContain('Ligue 1')
    ...
    expect(tour).toContain("router.push('/market/players')")
    expect(tour).toContain('Build my team')
    expect(tour).toContain('Show me the steps')
