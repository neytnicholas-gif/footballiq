...
export function BetaFeedbackButton() {
  ...
  return <aside aria-label="Beta feedback"><a href={href} className="fixed bottom-4 right-4 z-40 inline-flex min-h-11 items-center gap-2 rounded-full border border-emerald-200/30 bg-emerald-950 px-4 py-3 text-sm font-black text-white shadow-xl transition hover:-translate-y-0.5 hover:bg-emerald-900 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-700" aria-label="Send beta feedback about this page"><MessageSquareText className="size-4" /><span className="hidden sm:inline">Beta feedback</span></a></aside>
}
