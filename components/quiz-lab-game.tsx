...
export function QuizLabGame({ format }: { format: QuizLabFormat }) {
  ...
  const xp = 20 + score * 10 + (score === questions.length ? 40 : 0)
  ...
  return <section className="overflow-hidden rounded-[1.75rem] border border-slate-700 bg-slate-900/80 shadow-2xl shadow-black/30">
