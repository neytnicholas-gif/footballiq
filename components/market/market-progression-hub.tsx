...
export function MarketProgressionHub() {
  ...
  if(loading)return <ClubhouseLoading />
  ...
  return <div className="space-y-5">
    ...
    {!closest&&progression.challenges.length?<section className="rounded-[2rem] border border-amber-300/60 bg-amber-50 p-6 sm:p-7"><p className="text-xs font-black uppercase tracking-[.2em] text-amber-800">Challenge board complete</p><h2 className="mt-2 text-2xl font-black text-amber-950">You earned every available badge.</h2><p className="mt-2 text-sm text-amber-950/75">Your full collection is waiting in My Profile. New challenges will appear here when they are released.</p></section>:null}
