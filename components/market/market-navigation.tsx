...
import { Award, LayoutGrid, ShoppingBag, Sparkles } from 'lucide-react'
...
export function MarketNavigation() {
  ...
  return (
    <nav aria-label="Player Market sections" className="mb-5 grid grid-cols-2 gap-2 rounded-2xl border border-emerald-900/10 bg-white/75 p-2 shadow-sm backdrop-blur md:grid-cols-4">
