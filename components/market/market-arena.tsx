...
import { Check, Clock3, LockKeyhole, RefreshCw, ShieldCheck, Swords, Users } from 'lucide-react'
...
export function MarketArena() {
  ...
  return <div className="space-y-6">
    ...
    <section className="grid gap-5 lg:grid-cols-[1.1fr_.9fr]">
      ...
      <div className="rounded-[2rem] border border-border bg-card p-6 sm:p-8"><ShieldCheck className="size-8 text-primary"/><h2 className="mt-4 text-2xl font-black">Fair by design</h2><div className="mt-4 space-y-3 text-sm leading-6 text-muted-foreground"><p><strong className="text-foreground">No staking:</strong> you never risk VX or lose credits to another player.</p><p><strong className="text-foreground">Equal measure:</strong> the winner is decided by percentage squad movement, not who began richer.</p><p><strong className="text-foreground">Real gameweek:</strong> only verified ratings and minutes that reach The Reveal count.</p><p><strong className="text-foreground">Skill matching:</strong> the system looks near your rating first and widens only when necessary.</p><p><strong className="text-foreground">Game-funded prizes:</strong> winner 75 credits, draw 35 each, participation 15.</p></div></div>
    </section>
