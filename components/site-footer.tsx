...
import { LEGAL_CONTACT_EMAIL, legalLinks } from '@/lib/legal'
...
const socials: Array<{ label: string; href: string; icon: typeof Mail }> = [
  { label: 'Email', href: `mailto:${LEGAL_CONTACT_EMAIL}`, icon: Mail },
]
  ...
  return (
    <footer id="contact" className="relative border-t border-border">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6">
          ...
          <div className="relative overflow-hidden rounded-[32px] border border-border bg-card p-8 text-center sm:p-12">
            ...
            <div className="relative">
              ...
              <div className="mt-7 flex flex-col justify-center gap-3 sm:flex-row">
                ...
                <a href={`mailto:${LEGAL_CONTACT_EMAIL}`} className="inline-flex h-12 items-center justify-center rounded-xl border border-border bg-transparent px-7 font-medium hover:bg-secondary">
        ...
        <div className={`${compact ? 'mt-0' : 'mt-14'} flex flex-col gap-10 md:flex-row md:items-start md:justify-between`}>
          ...
          <div>
            ...
            <a href={`mailto:${LEGAL_CONTACT_EMAIL}`} className="mt-4 inline-flex text-sm text-muted-foreground transition-colors hover:text-foreground">
              {LEGAL_CONTACT_EMAIL}
            </a>
