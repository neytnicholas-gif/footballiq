...
async function buildSportmonksLeagueCatalogue(
  ...
  for (const row of squads) {
    ...
    players.push({
      ...
      data_source_label: 'Sportmonks-sourced squad data · Verdict XI opening game price',
      ...
      decision_support_note: currentUpdate
        ? `Verified ${currentUpdate.appearancesUsed}-appearance rolling rating: ${currentUpdate.rollingRating.toFixed(2)}. Latest movement follows Verdict XI v2 controls.`
