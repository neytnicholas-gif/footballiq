...
function hydratePublicCataloguePlayer(player: PublicCataloguePlayer): MarketPlayer {
  return {
    ...
    data_source_label: 'Provider-sourced identity · Early Shout game price book',
    ...
    decision_support_note: player.current_value === player.opening_season_value
      ...
      : 'Eligible match evidence has been processed using Early Shout’s published game-price rules.',
