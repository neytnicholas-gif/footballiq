    ...
    <main className="min-h-screen bg-background px-4 py-10 text-foreground">
      <div className="mx-auto max-w-md">
        ...
        <SurfaceCard className="mt-10 p-6 sm:p-8">
          ...
          <p className="mt-3 text-sm text-muted-foreground">Letters, numbers and underscores only. This is the name that appears on your Early Shout profile and leaderboards.</p>
