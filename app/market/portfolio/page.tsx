        ...
        {importResult?.imported ? (
          <div className="mb-4 flex items-start justify-between gap-3 rounded-2xl border border-emerald-700/25 bg-emerald-50 px-4 py-3 text-sm text-emerald-950 shadow-sm">
            <div>
              ...
              <p className="mt-1 text-xs text-emerald-900/75">Preserved {importResult.holdings ?? 0} player selections and {importResult.watchlist ?? 0} watchlist picks at current Verdict XI prices.</p>
            </div>
