...
const modes = [
  ...
  { kind: 'quiz', title: 'Truth Trap', description: 'Three statements are sound. Find the one false football claim.', href: '/quizzes/quiz-lab/truth-trap', icon: ShieldQuestion, accent: 'rose', count: `${quizLabQuestionBank['truth-trap'].length} challenges`, duration: '12 per round', skill: 'Careful reading' },
  { kind: 'quiz', title: 'Order the Play', description: 'Build a decision, routine or team move in the correct order.', href: '/quizzes/quiz-lab/order-the-play', icon: ListOrdered, accent: 'amber', count: `${quizLabQuestionBank['order-the-play'].length} challenges`, duration: '12 per round', skill: 'Sequences' },
  { kind: 'quiz', title: 'Link-Up Board', description: 'Connect four football roles, rules or clues to their correct partners.', href: '/quizzes/quiz-lab/link-up', icon: Link2, accent: 'violet', count: `${quizLabQuestionBank['link-up'].length} boards`, duration: '12 per round', skill: 'Connections' },
  { kind: 'quiz', title: 'Formation Fix', description: 'See the problem area on the pitch and choose the missing role.', href: '/quizzes/quiz-lab/formation-fix', icon: Target, accent: 'emerald', count: `${quizLabQuestionBank['formation-fix'].length} pitch problems`, duration: '12 per round', skill: 'Shape reading' },
  { kind: 'game', title: 'Higher or Lower', description: 'Keep a streak alive by comparing one player record with the next.', href: '/quizzes/higher-or-lower', icon: TrendingUp, accent: 'rose', count: `${higherLowerItems.length} cards · 10 decks`, duration: 'Quick run', skill: 'Stats' },
  { kind: 'game', title: 'Who Am I?', description: 'Open clues and guess the hidden player before your points run out.', href: '/quizzes/who-am-i', icon: Search, accent: 'violet', count: `${whoAmIQuestions.length} players · 10 sets`, duration: '5–10 min', skill: 'Deduction' },
  { kind: 'game', title: 'Career Path', description: 'Look at the clubs and guess which player had that career.', href: '/quizzes/career-path', icon: GitBranch, accent: 'sky', count: `${careerQuestions.length} careers · 10 routes`, duration: '5–10 min', skill: 'Recall' },
] as const
