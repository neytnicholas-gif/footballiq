...
export default function QuizzesPage() {
  return <main className="min-h-screen bg-background"><SiteHeader/><section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 sm:py-16">
    <div className="max-w-3xl"><p className="text-xs font-semibold uppercase tracking-[.25em] text-primary">Quiz library</p><h1 className="mt-4 text-5xl font-bold tracking-tight sm:text-6xl">Train football judgement.</h1><p className="mt-4 text-lg text-muted-foreground">Start with Scout Vision and Referee Arena, then sharpen speed and recall in specialist challenge modes.</p></div>
