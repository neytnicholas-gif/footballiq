    ...
    <main className="min-h-screen bg-[#07111f] text-slate-100">
      ...
      <section className="mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-11">
        <div className="mb-7 max-w-3xl">
          ...
          <p className="mt-4 text-base leading-7 text-slate-300">Choose a league, answer 15 clear questions and earn XP. Start with England, then travel through 24 competitions.</p>
        </div>
        <LeagueWorld />
      </section>
    </main>
