...
const freeNow = [
  'All current quizzes and three 450-question football games',
      ...
      <section className="mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-14">
        <SurfaceCard className="overflow-hidden">
          <div className="bg-[linear-gradient(135deg,rgba(34,197,94,.18),rgba(59,130,246,.12),rgba(8,14,26,.96))] p-7 text-white sm:p-10">
            ...
            <p className="mt-4 max-w-3xl text-base leading-relaxed text-slate-300 sm:text-lg">All current learning experiences are free. Player Market access is also free during testing. Early Shout is not collecting a subscription or one-off game payment today.</p>
          </div>
        </SurfaceCard>
