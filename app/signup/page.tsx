      ...
      <div className="mx-auto max-w-md">
        ...
        <div className="mt-10 rounded-3xl border border-border bg-card p-6 shadow-2xl">
          ...
          <form onSubmit={signUp} className="mt-6 space-y-4">
            ...
            <label className="block text-sm font-medium">Password<input name="password" type="password" autoComplete="new-password" minLength={6} value={password} onChange={(e) => setPassword(e.target.value)} required className="mt-2 h-11 w-full rounded-xl border border-border bg-background px-4 outline-none focus:ring-2 focus:ring-primary/40" /></label>
