...
const opportunities = [
  ...
  { title: 'Content partner', description: 'Back an original Verdict XI learning series. Editorial answers and game outcomes always stay independent.', icon: BarChart3 },
]
...
export default function PartnersPage() {
  const subject = encodeURIComponent('Verdict XI partnership enquiry')
  return (
    <main className="min-h-screen bg-[#060b13] text-slate-100">
      ...
      <section className="mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-16">
        <div className="overflow-hidden rounded-[2rem] border border-white/12 bg-[radial-gradient(circle_at_12%_10%,rgba(16,185,129,.18),transparent_38%),linear-gradient(145deg,#0b1727,#08111e)] p-6 shadow-2xl sm:p-10">
          ...
          <p className="mt-5 max-w-2xl text-base leading-7 text-slate-300 sm:text-lg">Verdict XI is building a free football-learning audience and a player-value game. We are opening a small number of honest, clearly labelled launch partnerships.</p>
          <div className="mt-7 flex flex-wrap gap-3">
            ...
            <Link href="/" className="inline-flex min-h-11 items-center rounded-xl border border-white/15 bg-white/5 px-5 py-3 font-bold transition hover:bg-white/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-300">Explore Verdict XI</Link>
          </div>
        </div>
