...
export default function BetaPage() {
  ...
  const feedbackHref = `mailto:${BRAND.supportEmail}?subject=${encodeURIComponent('FootballIQ beta feedback')}&body=${encodeURIComponent('Page or feature:\n\nWhat happened:\n\nWhat did you expect:\n\nDevice/browser:\n\nAnything you especially liked:')}`
      ...
      <section className="mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-14">
        <SurfaceCard className="overflow-hidden">
          <div className="bg-[linear-gradient(135deg,rgba(16,185,129,.2),rgba(59,130,246,.13),rgba(8,14,26,.97))] p-7 text-white sm:p-10">
            ...
            <h1 className="mt-4 max-w-4xl text-4xl font-black tracking-tight sm:text-6xl">Help shape FootballIQ before the paid launch.</h1>
            <p className="mt-4 max-w-3xl text-base leading-relaxed text-slate-300 sm:text-lg">Play the quizzes and Player Market free, report what feels brilliant or broken, and build the first real FootballIQ community.</p>
          </div>
        </SurfaceCard>
        ...
        <div className="mt-6 grid gap-5 lg:grid-cols-[1.08fr_.92fr]">
          <SurfaceCard className="p-6 sm:p-7">
            ...
            <p className="mt-3 text-sm leading-relaxed text-muted-foreground">Join with your FootballIQ account during the founder beta. If paid Player Market access launches, your account will receive its first 12 months free. There is no payment, card request or automatic renewal today.</p>
          ...
          <div className="grid gap-5">
            ...
            <SurfaceCard className="p-6">
              ...
              <p className="mt-3 text-sm leading-relaxed text-muted-foreground">Features, rules and values can change while testing. FIQ Credits are free game credits with no cash value. FootballIQ is independent and is not affiliated with any league, club, player or data provider.</p>
