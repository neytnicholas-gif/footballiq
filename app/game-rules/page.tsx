...
export default function GameRulesPage() {
  return <LegalPage title="Player Market Game Rules" summary="A plain-language description of the FootballIQ Player Market. These rules should be read together with the Terms of Use.">
    ...
    <section><h2>3. Buy and sell players</h2><p>You can buy up to 11 players in each gameweek if you have enough FIQ Credits and space in your team. You can sell players to open a space. The confirm screen shows the exact game price before you trade.</p></section>
    <section><h2>4. How prices change</h2><p>These are FootballIQ game prices, not real player values. After a match finishes, we use the player’s rating and minutes to work out a small rise, fall or no change. Limits stop one match from changing a price too much.</p></section>
    ...
    <section><h2>6. See your results</h2><p>After the price update, the Reveal page shows what happened to your team and each player. Leaderboards only compare scores inside this game. FIQ Credits and player prices are not real money.</p></section>
